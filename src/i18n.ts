  ...
  zh: {
    translation: {
      ...
      home: {
        hero_head: '一个演示壳，',
        hero_tail: '两条交易链路',
        hero_sub: '扫码绑定桌号，体验多人协同点餐与酒店预订两条核心链路。',
        feature_rooms: '房型搜索 / 日期选择 / 多间多晚',
        feature_ops: '订单管理 / 客服工单 / 运营后台',
      },
      hotel: {
        brand_name: '云栖',
        subtitle: '酒店预订',
  ...
  en: {
    translation: {
      common: {
        ...
        banner_hotel: 'Cloudnest · Hotel Booking Concept Demo',
        brand: '沸',
      ...
      home: {
        hero_head: 'One demo shell, ',
        hero_tail: 'two transaction journeys',
        hero_sub: 'Scan to bind a table and try collaborative hotpot ordering and hotel booking.',
        feature_rooms: 'Room search · Date picker · Multi-room & multi-night',
        feature_ops: 'Order management · Support tickets · Admin console',
      },
      hotel: {
        ...
        draft_count: '{{count}} room(s) in cart',
